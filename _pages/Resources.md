...
# **Lab Resources**
Our lab is equipped with state-of-the-art technology dedicated to advancing research in emerging technologies. Below are some of the key resources available to our team, grouped into relevant segments.
...
<h2 class="section-title">Physiological Monitoring Devices</h2>
<div class="resource-container">
  <div class="resource">
    <img src="/_pages/resources_pictures/embrace plus.jpg" alt="EmbracePlus">
    <h3 class="resource-title">EmbracePlus</h3>
  ...
  <div class="resource">
    ...
    <h3 class="resource-title">Actiheart 5</h3>
...
<h2 class="section-title">3D Scanning & Reality Capture</h2>
<div class="resource-container">
  <div class="resource">
    <img src="/_pages/resources_pictures/laser_scanner.jpg" alt="Trimble X9">
    <h3 class="resource-title">Trimble X9 Laser Scanner</h3>
  ...
  <div class="resource">
    ...
    <h3 class="resource-title">Trimble RealWorks Licenses</h3>
...
<h2 class="section-title">Mixed Reality & Visualization</h2>
<div class="resource-container">
  <div class="resource">
    <img src="/_pages/resources_pictures/meta_quest.jpg" alt="Meta Quest 3">
    <h3 class="resource-title">Meta Quest 3</h3>
...
<!-- Aerial Imaging & Site Monitoring -->
<h2 class="section-title">Aerial Imaging & Site Monitoring</h2>
<div class="resource-container">
  <div class="resource">
    <img src="/_pages/resources_pictures/evo_drone.jpg" alt="Evo Max 4T">
    <h3 class="resource-title">Evo Max 4T Drone</h3>
  ...
  <div class="resource">
    <img src="/_pages/resources_pictures/gopro.jpg" alt="GoPro Camera">
    <h3 class="resource-title">GoPro Camera</h3>
...
<h2 class="section-title">Field Measurement Tools</h2>
<div class="resource-container">
  <div class="resource">
    <img src="/_pages/resources_pictures/measuring_wheel.jpg" alt="Measuring Wheels">
    <h3 class="resource-title">Measuring Wheels</h3>
